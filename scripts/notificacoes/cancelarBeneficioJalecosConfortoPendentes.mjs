...
import { JALECOS_CONFORTO_DADOS_TIPO } from '../../utils/beneficioJalecosConfortoCampaign.js';
  ...
  return queryWithContext(
    ...
    `
      ...
      SET
        ...
        fn.UltimoErro = N'Campanha Jalecos Conforto cancelada administrativamente.',
