...
const twilioWhatsappContentSidLembreteConsulta24h = optionalEnv(
  'TWILIO_WHATSAPP_CONTENT_SID_LEMBRETE_CONSULTA_24H'
);
const twilioWhatsappContentSidCheckinFisio = optionalEnv(
  'TWILIO_WHATSAPP_CONTENT_SID_CHECKIN_FISIO'
);
const twilioWhatsappContentSidCheckinPaciente = optionalEnv(
  'TWILIO_WHATSAPP_CONTENT_SID_CHECKIN_PACIENTE'
);
...
export const ENV = {
  ...
  TWILIO_WHATSAPP_CONTENT_SID_CHECKIN_FISIO: twilioWhatsappContentSidCheckinFisio,
  TWILIO_WHATSAPP_CONTENT_SID_CHECKIN_PACIENTE: twilioWhatsappContentSidCheckinPaciente,
  ...
  CHECKIN_ORIENTACAO_WORKER_ENABLED: process.env.CHECKIN_ORIENTACAO_WORKER_ENABLED,
  CHECKIN_ORIENTACAO_EMAIL_ENABLED: process.env.CHECKIN_ORIENTACAO_EMAIL_ENABLED,
  CHECKIN_ORIENTACAO_WHATSAPP_ENABLED: process.env.CHECKIN_ORIENTACAO_WHATSAPP_ENABLED,
  CHECKIN_ORIENTACAO_MINUTOS_ANTES: process.env.CHECKIN_ORIENTACAO_MINUTOS_ANTES,
  CHECKIN_ORIENTACAO_MINIMO_MINUTOS_ANTES: process.env.CHECKIN_ORIENTACAO_MINIMO_MINUTOS_ANTES,
  CHECKIN_ORIENTACAO_BATCH_SIZE: process.env.CHECKIN_ORIENTACAO_BATCH_SIZE,
  CHECKIN_ORIENTACAO_CONSULTA_ID: process.env.CHECKIN_ORIENTACAO_CONSULTA_ID,
};
